...
Kept as a single resource rather than one-per-topic — an agent working ATAT
for the first time in a session wants the whole picture in one fetch, not a
menu of documents to guess between.
"""
